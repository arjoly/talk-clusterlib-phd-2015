...
\title{The genesis of clusterlib \\An open source library to tame your favourite supercomputer}
% \institute[Ulg]{\includegraphics[height=2cm]{logo_coul_texte_blason_cadre}}
\date{May 2015, Phd hour discussions}
\subject{}
...
But, we have \alert{embarrassingly parallel tasks}.
...
consortium funded by the FNRS.}}, we have access to 
...
\begin{frame}
    ...
    \only<1>{
        ...
        clusterlib uses \alert{Travis CI} (works for a lot languages).
